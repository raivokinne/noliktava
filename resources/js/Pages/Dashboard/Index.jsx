        ...
        <Authenticated>
            <div className="relative h-screen text-white">
                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="w-full max-w-md p-4 m-auto text-center">
                        {loading ? (
                            ...
                            <div className="p-8 bg-gray-800 rounded-lg shadow-lg">
                                <div className="mb-6">
                                    <h1 className="mb-4 text-3xl font-bold text-center">
                                        Welcome {user.name} to XYZ Storage
                                    </h1>
                                    <p className="mb-8 text-center text-gray-400">
                                        Whether you're a construction worker,
                                        landscaper, or tradesperson, we
                                        understand that your tools and equipment
                                        are essential to your job. That's why we
                                        offer a range of storage options
                                        designed specifically for workers like
                                        you.
                                    </p>
                                </div>
                            </div>
