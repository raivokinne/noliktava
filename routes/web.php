...
Route::middleware(IsAdmin::class)->group(
    function () {
        ...
        Route::get('/shelfs/{shelf}/show', [ShelfController::class, 'show'])->name('shelf.show');
        ...
        Route::get('/reports/{id}/show', [ReportsController::class, 'show'])->name('report.show');
        Route::get('/reports/{id}/edit', [ReportsController::class, 'edit'])->name('report.edit');
        Route::put('/reports/{id}/update', [ReportsController::class, 'update'])->name('report.update');
        ...
        Route::delete('/reports/{id}/destroy', [ReportsController::class, 'destroy'])->name('report.destroy');
    }
);
